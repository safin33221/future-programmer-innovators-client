...
export function AboutClub() {
    return (
        <section className="py-12 bg-linear-to-b from-background via-primary/5 to-background relative overflow-hidden">
            ...
            <div className="container px-4 md:px-6 relative mx-auto">
                <div className="max-w-4xl mx-auto text-center space-y-8">
                    ...
                    <p className="text-lg md:text-xl leading-relaxed text-muted-foreground max-w-3xl mx-auto">
                        ...
                        Feni Polytechnic Institute students through <span className="text-foreground font-semibold">real-world projects</span>,
